...
public class CallKeynectisServiceImpl implements ICallKeynectisServiceRemote {
    ...
    private void pdf2xml(byte[] fileArray, String pdfFileName)
        throws IOException {
        if (fileArray != null) {
            try {
    ...
    public String digitalSignature() throws Exception {
        ...
        URL url =
            this.getClass()
                .getClassLoader()
                .getResource("example/" + pdfFileName);
        ...
        RequestTransId rti = new RequestTransId(
            Settings.DIGITAL_SIGNATURE_ID_APPLICATION.getSetting(),
        ...
        Reader reader = new InputStreamReader(
            this.getClass()
                .getClassLoader()
                .getResourceAsStream("Keynectis/demoqs-i.p12"),
            "UTF-8"
        );
        ...
        rti.setReturnUrl(
            Settings.PUBLIC_URL_BO.getSetting() +
            CommonMapping.MAPPING_TRANS_ID_REPLY
        );

        rti.setEmail("apteagrouptest@gmail.com");

        String tag =
            "DATA_METIER=formulaire\n" +
            "CUF_ORG=no\n" +
            "TYPE=38\n" +
            "VISU=docPDFb64\n" +
            ...
            "EXTRA_PARAM=demo=demoPDFSMS;numTelSMS=0651107979;smsBody=Bonjour. Voici votre code de signature : " +
            rti.getCuf() +
            ". " +
        ...
        URL pathXmlFileDsig =
            this.getClass()
                .getClassLoader()
                .getResource("Keynectis/demoqs-s.p12");
        ...
        HttpPost httpPost = new HttpPost(
            Settings.DIGITAL_SIGNATURE_SUBMIT_URL.getSetting()
        );
